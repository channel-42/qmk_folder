 ...
 */
 ...
 [_QWERTY] = LAYOUT( \
  ...
  KC_LCTRL, KC_A,   KC_S,    KC_D,    KC_F,    KC_G,                     KC_H,    KC_J,    KC_K,    KC_L,    DE_OE, DE_AE, \
...
[_LOWER] = LAYOUT( \
  ...
  KC_GRV, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC,                    KC_LEFT, KC_UP, KC_DOWN, KC_RIGHT, DE_HASH, KC_TILD, \
...
[_RAISE] = LAYOUT( \
  ...
  KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,   DE_LCBR, _______,  KC_PLUS, KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, KC_BSLS, \
                             _______, _______, _______,  _______, _______,  _______, _______, _______ \
),
/* ADJUST
 * ,-----------------------------------------.                    ,-----------------------------------------.
